...
const AdvancedRatingPopup = (props) => {
  ...
  const calcPercentage = (star) => {
    return reviewTotal[star].length === 0 ? 0 : ((reviewTotal[star].length / listing.reviews.length).toFixed(2)) * 100;
  }
  ...
  return (
    <React.Fragment>
      ...
      >
        <MenuItem sx={{gap: '10px'}} onClick={(event) => {
                                      event.stopPropagation();
                                      event.preventDefault();
                                      openReviews(5);
                                      closePopover();
          ...
          <div className={classes.root}>
            <BorderLinearProgress sx={{height: '20px', width: '200px'}} variant="determinate" value={calcPercentage(5)} />
          </div>
        ...
        <MenuItem sx={{gap: '10px'}} onClick={(event) => {
          ...
          <div className={classes.root}>
            <BorderLinearProgress sx={{height: '20px', width: '200px'}} variant="determinate" value={calcPercentage(4)} />
          </div>
        ...
        <MenuItem sx={{gap: '10px'}} onClick={(event) => {
          ...
          <div className={classes.root}>
            <BorderLinearProgress sx={{height: '20px', width: '200px'}} variant="determinate" value={calcPercentage(3)} />
          </div>
        ...
        <MenuItem sx={{gap: '10px'}} onClick={(event) => {
          ...
          <div className={classes.root}>
            <BorderLinearProgress sx={{height: '20px', width: '200px'}} variant="determinate" value={calcPercentage(2)} />
          </div>
        ...
        <MenuItem sx={{gap: '10px'}} onClick={(event) => {
          ...
          <div className={classes.root}>
            <BorderLinearProgress sx={{height: '20px', width: '200px'}} variant="determinate" value={calcPercentage(1)} />
          </div>
        ...
        <MenuItem sx={{gap: '10px'}} onClick={(event) => {
          ...
          <div className={classes.root}>
            <BorderLinearProgress sx={{height: '20px', width: '200px'}} variant="determinate" value={calcPercentage(0)} />
          </div>
