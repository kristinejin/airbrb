                  ...
                  <Collapse in={open} timeout="auto" unmountOnExit>
                    <Table>
                      ...
                      <TableBody>
                        {pastBookings
                          .slice(
                            pastBookingPage * rowsPerPastBookingPage,
                            pastBookingPage * rowsPerPastBookingPage +
                              rowsPerPastBookingPage
                          )
                          .map((row) => (
                            <TableRow key={row.id}>
                              ...
                              <TableCell
                                ...
                                align="right"
                              >
                                {turnIntoDate(row.dateRange.startdate)}
                              </TableCell>
                              <TableCell
                                sx={{
                                  display: { xs: 'none', sm: 'table-cell' },
                                ...
                                align="right"
                              >
                                {turnIntoDate(row.dateRange.enddate)}
                              </TableCell>
                        ...
                        {pastBookingPage !== 0 &&
                          emptyRowsPerPastBookingPage > 0 && (
                            <TableRow
                              sx={{ height: 53 * emptyRowsPerPastBookingPage }}
                            >
                              <TableCell colSpan={6} />
                            </TableRow>
                        )}
      ...
      <Box sx={{ padding: '40px' }}>
        ...
        <TableContainer component={Paper}>
          <Table aria-label="bookingTable">
            <TableHead>
              <TableRow>
                <TableCell sx={{ display: { sm: 'none', md: 'table-cell' } }}>
                  Requester
                </TableCell>
                <TableCell
                  sx={{ display: { xs: 'none', sm: 'table-cell' } }}
            ...
            <TableBody>
              {bookings
                .slice(
                  ...
                  bookingPage * rowsPerBookingPage + rowsPerBookingPage
                )
                .map((row) => (
                  <TableRow key={row.id}>
                    <TableCell
                    ...
                    <TableCell align="right">
                      <Button
                        name="accept"
                        color="success"
                        onClick={() => handleBookingStatus(row.id, 'accept')}
                      >
                        Accept
                      </Button>
                      <span>/</span>
                      <Button
                        color="warning"
                        onClick={() => handleBookingStatus(row.id, 'decline')}
                      >
                        Deny
                      </Button>
                    </TableCell>
